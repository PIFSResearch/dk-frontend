  ...
  contentEl.innerHTML = `
    ...
    <section class="card">
      ...
      <p style="font-size:12px;color:var(--text-muted);margin:12px 0 0">
        Monetary values shown in U.S. dollars (USD). For public companies, the
  multiple is set to 0, and price represents the market capitalization
  closest to the filing date. Click a row to open its
        filing.
      </p>
    </section>
  `;
